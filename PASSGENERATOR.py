...
def generate_password():
    try:
        ...
        label_status.configure(text="Password generated successfully!", text_color="green", font=("Lexend Giga", 14, "bold"))
    except ValueError:
...
# Password Display
entry_password = ctk.CTkEntry(root, width=300, font=("Arial", 14), justify="center", state="normal")
